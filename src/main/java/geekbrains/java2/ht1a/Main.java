...
public class Main 
{
    ...
    private static void array1() {
		...
		for (int ma : mas) { //выводим элементы массива на консоль
    ...
    private static void array2() {
		...
		for (int anArray2 : array2) { // выводим элементы массива на консоль
    ...
    private static void array3(){
		...
		for (int anArray3 : array3) {    // выводим элементы массива на консоль
    ...
    private static double addition(double x, double y) {//метод сложения двух чисел
    	double addResult;
    	addResult = x+y;
    	return addResult;
    }
    
    private static double subtraction(double x, double y) {//метод вычитания двух чисел
    	double subResult;
    	subResult = x-y;
    	return subResult;    	
    }
    
    private static double multiplication(double x, double y) {//метод умножения двух чисел
    	double multResult;
    	multResult = x*y;
    	return multResult;    	
    }
    
    private static double division(double x, double y) {//метод деления двух чисел
    	double divResult;
    	divResult = x/y;
        return divResult;    	
    }
   ...
   // 5) Только с помощью написанных методов из п.4 выполнить расчет выражения ((2 + 3) * 5) / 2 
    ...
    private static void formula() { //метод вычисления формулы
